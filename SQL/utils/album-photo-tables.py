...
cursor.execute ("CREATE TABLE `Album` (`albumID` varchar(100) NOT NULL, `name` TEXT NOT NULL, `description` TEXT NOT NULL, `thumbnailURL` TEXT NOT NULL, `createdAt` TIMESTAMP DEFAULT CURRENT_TIMESTAMP, `createdBy` TEXT NOT NULL, PRIMARY KEY (`albumID`));")
